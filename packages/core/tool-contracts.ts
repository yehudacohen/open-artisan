...
export const TOOL_CONTRACTS = [
  ...
  toolContract({ name: "mark_satisfied", description: "Submit isolated phase-review criteria assessment for the current artifact.", schema: MarkSatisfiedToolSchema, workflowGuard: true, exposeTo: ["bridge", "mcp", "opencode"], mcpName: "oa_mark_satisfied" }),
  ...
  toolContract({ name: "submit_task_review", description: "Submit per-task isolated review results.", schema: SubmitTaskReviewToolSchema, workflowGuard: true, exposeTo: ["bridge"] }),
