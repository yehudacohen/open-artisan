...
import type { WorkflowState, SessionStateStore, StateMachine, RevisionStep } from "./types"
...
/** Dependencies injected from the plugin scope. */
export interface CascadeAutoSkipDeps {
  store: SessionStateStore
  sm: StateMachine
  log: Logger
  /** Bun shell `$` — used for git diff in revision-baseline functions. */
